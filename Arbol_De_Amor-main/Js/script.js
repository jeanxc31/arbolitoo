...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con mucho amor,\nese señor que usted dice amar <3. ";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-05-05T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-05-05T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `Desde el primer beso después de años han pasado: <b>${days}</b> días<br>` +
      `Fechita importante, la verdad <3: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
